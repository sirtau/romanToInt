...
//                 or
//         if ( 1 < 10 ) {
//  JavaScript will automatically identify the roman numerals, giving true in this case.
//
//  In the following 2 examples, it is not accessing the Numbers object:
//          console.log("I" < "X") 
//              returns true
//          console.log("X" < "I") 
//              returns false
...
const testsArray = [
    ...
    "MMMCMXCIX", // returns 3999     "MMMCMXCIX"  =  M+M+M + (M-C) + (C-X) + (X-I)  =  1000+1000+1000 + (1000-100) + (100-10) + (10-1)  =  3999     
